...
There are 4 tests that measure different aspects of the model’s performance with one or more subtests, e.g. energy and interatomic force prediction. Each subtest is given a score, such that all models are compared across 12 metrics. 
